...
const HowItWorksPage = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#0F1117] text-[#E8E4D9]">
      <header
        className="fixed left-1/2 z-50 flex w-[calc(100%-1rem)] max-w-4xl -translate-x-1/2 items-center justify-between rounded-[18px] border border-white/10 bg-[rgb(15_17_23/0.66)] px-3 py-2 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:w-[calc(100%-2rem)] sm:px-4 sm:py-3 md:w-[calc(100%-3rem)]"
      ...
      >
        ...
        <nav className="flex items-center gap-1">
          ...
          <Button
            asChild
            variant="ghost"
            className="hidden h-9 rounded-lg border border-white/15 bg-white/[0.08] px-3 text-sm font-medium text-[#E8E4D9] hover:bg-white/[0.12] sm:inline-flex"
          >
